...
- Generalized restricted OpenAI-compatible tool schema conversion into an extensible MFJS protocol profile selected through model capabilities instead of a provider-named formatter.
